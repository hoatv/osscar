...
class MyListItem extends React.PureComponent {
    openCorespondingApp(url) {
        ...
        // format url facebook :https://www.facebook.com/groups/329058747228404/permalink/874360099364930/
    ...
    render() {
        ...
        return (
            ...
            >
                <Left>
                    <Image style={styles.imageRound} source={require('../img/Topicagroup.jpg')} />
                </Left>
                <Body style={{ borderBottomColor: 'white' }}>
                    {
                        item.title === null ? <Text numberOfLines={1} style={styles.titleStyle}>{item.content}</Text> : null
                    }
                    <View style={styles.infoDetail}>
                        ...
                        <View style={styles.phoneStyle} note>
                            ...
                            <Text style={styles.typeFontSizeStyle} >Topica Group</Text>
                        </View>
                    </View>
                </Body>
                <Right>
...
class FacebookGroupTab extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async loadMore() {
        ...
        await this.props.paging('facebook', this.state.start, this.state.end);
...
export default FacebookGroupTab; 