...
class MyListItem extends React.PureComponent {
    ...
    render() {
        ...
        return (
            ...
            >
                <Left>
                    <Image style={styles.imageRound} source={require('../img/TopicaGDoc.jpg')} />
                </Left>
                <Body style={{ borderBottomColor: 'white' }}>
                    ...
                    <View style={styles.infoDetail}>
                        ...
                        <View style={styles.phoneStyle} note>
                            ...
                            <Text style={styles.typeFontSizeStyle} >Google Drive</Text>
                        </View>
                    </View>
                </Body>
                <Right>
...
class GoogleTab extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async loadMore() {
        ...
        await this.props.paging('google', this.state.start, this.state.end);
