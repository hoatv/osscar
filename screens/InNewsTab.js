...
class MyListItem extends React.PureComponent {
    ...
    render() {
        ...
        const url_image = item.url_image === null ? '../img/default-user-image.png' : item.url_image;
        return (
            <ListItem avatar key={item.item_id} onPress={() => this.openCorespondingApp(item.url)}
                style={{ borderBottomColor: 'rgb(234, 230, 229)', borderBottomWidth: 1, marginLeft: 0, paddingLeft: 10, flex: 1 }}
            >
                <Left>
                ...
                <Body style={{ borderBottomColor: 'white' }}>
                    <Text numberOfLines={1} style={styles.titleStyle}>{decodeHtmlEntity(item.title)}</Text>
                    <View style={styles.infoDetail}>
                        ...
                        <View style={styles.phoneStyle} note>
                            ...
                            <Text style={styles.typeFontSizeStyle} >Innews</Text>
                        </View>
                    </View>
                </Body>
                <Right>
...
class InNewsTab extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async loadMore() {
        ...
        await this.props.paging('innews', this.state.start, this.state.end);
